...
function fullview(){
	document.getElementById('extent_ajax').value = "124005 4845 935385 318165";
...
function export_pdf(){
	window.open("../export_info.php","","menubar=no,scrollbars,width=600,height=250");
}
...
function login2(){
	curr_user_win = window.open("../login/login.php","w2","menubar=no,scrollbars,width=600,height=300,top=150"); //parent.curr_user_win =
