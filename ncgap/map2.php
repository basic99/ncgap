...
$(function() {
   setmapctls();
	...
	pan();
	parent.controls.location = "controls2.php";
	var shape_error = $('#shape_error').val();
	if(shape_error == 'none'){
		//gears = window.open("../gears.html","","width=400,height=200,top=200,left=200");
		//if(gears == null || gears == undefined){
		//	alert("Popup blocker blocked a window. \nYou should add www.gapserve.ncsu.edu as an exception.");
		//}
...
function send_ajax(){
	...
	var strelcode = $('#strelcode_ajax').val();
...
function loader(){
	var controls_loc = parent.controls.location.pathname;
	if (controls_loc.indexOf('controls.php') != -1){
		parent.controls.location = "controls2.php";
	}
	set_state();
	if(parent.curr_user_win.document){
...
function clip_zip(){
	if (parent.data.document.forms.fm4){
		if(parent.functions.location.pathname.indexOf("single.php") != -1 ){
			...
			var strelcode = parent.functions.document.forms.fm1.strelcode.value;
			parent.data.document.forms.fm4.strelcode.value = strelcode;
		} else {
			parent.data.document.forms.fm4.strelcode.value = "";
...
<input type="hidden" name="strelcode" value="" />
...
<input  type="hidden" name="strelcode"  />
...
<input type="hidden" class="aoikeys" id="topo_ajax" value="<?php  echo $topo_aoi; ?>" />
...
<input  type="hidden" name="strelcode" id="strelcode_ajax" />
<input  type="hidden" name="species_layer" id="species_layer_ajax" />
