 ...
 * Create new map object from $map = ms_newMapObj($mapfile) using ncgap.map.
...
<link rel="StyleSheet" href="/ncgap/styles/map.css" type="text/css" />
...
<td><input type="image" src="/graphics/ncgap/draw_up.png" id="draw" title="draw custom" onclick="draw()"/> </td>
<td><input  type="image" src="/graphics/ncgap/info_up.png" id="qry" title="Query" onclick="query()" /> </td>
...
<tr>
<td><input type="image" src="/graphics/ncgap/nc_full_up.png" title="Zoom to Full Extent" onclick="fullview()" /> </td>
<td><input type="image" src="/graphics/ncgap/resize_up.png" style="visibility: hidden" /> </td>
<td><input type="image" src="/graphics/ncgap/bullseye_up.png" title="zoom to co-ordinates" onclick="zoomcoord();" /> </td>
<td><input type="image" src="/graphics/ncgap/resize_up.png" title="reload frame size of map" onclick="resize();" /> </td>
<td><input type="image" src="/graphics/ncgap/aoi_up.png" title="Use AOI" onclick="login();" /> </td>
...
<option value="stat_d" >Parcel-GAP Status</option>
<option value="ownd">Parcel-Ownership</option>
<option value="mgrinst1">Parcel-Gen. Manage</option>
<option value="mand">Parcel-Spec. Manage</option>
<option value="maname" >Parcel-Name</option>
<option value="basin">River Basin</option>
<option value="sub_bas">Sub Basin</option>
<option value="bird_consv">Bird Cons. Region</option>
<option value="city">City</option>
<option value="county">County</option>
<option value="topo">Topo Map Name</option>
...
if(isset($user_x)){
	...
	$old_extent->setextent(124005,  4845,  935385, 318165);
}
...
<input type="hidden" class="aoikeys" name="sub_basin" id="sub_basin_aoi" />
...
<input type="hidden" name="sub_basin"  class="aoikeys" id="sub_basin_pdf" />
